...
<head>
  <meta charset="utf-8">
  <title>Edgile-StudentLogin</title>
  ...
  <link href="<?php echo web_root;?>plugins/homepage/assets/css/default.css" rel="stylesheet">
  <link href="<?php echo web_root;?>plugins/homepage/assets/css/home_p.css" rel="stylesheet">
  <link href="<?php echo web_root;?>chatroom/css/style.css" rel="stylesheet">
          ...
          <div class="container">
            ...
            <div class="navigation">
              <nav>
                <ul class="nav topnav">
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=home"><i class="icon-home"></i> Home</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=Videocall"><i class="icon-camera"></i> Videocall</a>
                  </li>
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=Doubts"><i class="icon-comment"></i> Doubts</a>
                  </li>
                  <li>
...
<?php check_message(); ?>
 ...
 <script src="<?php echo web_root;?>plugins/homepage/assets/js/jquery.js"></script>
  ...
  <script src="<?php echo web_root;?>chatroom/js/app.js"></script>
